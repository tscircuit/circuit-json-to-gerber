...
import waterCounterJson from "./WaterCounter.json"
import type { AnyCircuitElement } from "circuit-json"

test("repro1 water counter", async () => {
  const soup = waterCounterJson as AnyCircuitElement[]
  ...
  }).toMatchGerberSnapshot(import.meta.path, "repro1")
})
